...
export default function Loginpage(){
    ...
    const [saveUserName, saveUserEmail, saveUserPic, changeLoginStatus] = useDataStore((state) => [
        state.saveUserName,
        state.saveUserEmail,
        state.saveUserPic,
    ...
    const clientId = '782239294150-39nu17sk486jaaqhucqb4hvt0mbop9pn.apps.googleusercontent.com';
    ...
    <div className="login-page">
        ...
        <div className="login-f">
            ...
            <form className="login-form">
                ...
                <div className="input-group">
                    <input formcontrolname="password" type="password" className="form-control" placeholder="Password" required/>
                    <div className="input-group-append">
                        <div className="input-group-text">
                ...
                <div className="row">
                    ...
                    <div className="signingoogle">
                        {/* <button type="submit" className="buttongoogle"> */}
                        <GoogleLogin
                            clientId={clientId}
                            render={renderProps => (
                            <button onClick={renderProps.onClick} disabled={renderProps.disabled} className="buttongoogle"><img src="./images/btngoogle.png" alt="" className="googleimg" /></button>
                            )}
                            buttonText="Login"
                            onSuccess={onSuccess}
                            onFailure={onFailure}
